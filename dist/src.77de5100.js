...
var gamePipes$ = rxjs_1.interval(500).pipe(operators_1.scan(function (acc) {
  return (acc.length < 2 ? __spreadArrays(acc, [createPipes(gameSize)]) : acc).filter(function (c) {
...
var bird$ = rxjs_1.merge(rxjs_1.interval(300), rxjs_1.fromEvent(document, "keydown")).pipe(operators_1.scan(function (xPos, curr) {
...
rxjs_1.combineLatest(bird$, gamePipes$).pipe(operators_1.scan(function (state, _a) {
  var bird = _a[0],
      pipes = _a[1];
  return {
    bird: bird,
  ...
  return html_renderer_1.paint(updateGame(state.bird, state.pipes), state.lives, state.score);
}), operators_1.takeWhile(function (state) {
  return state.lives > 0;
})).subscribe();
},{"rxjs":"../node_modules/rxjs/_esm5/index.js","rxjs/operators":"../node_modules/rxjs/_esm5/operators/index.js","./html-renderer":"html-renderer.ts"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
